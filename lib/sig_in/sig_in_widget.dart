...
import 'sig_in_model.dart';
export 'sig_in_model.dart';
...
class _SigInWidgetState extends State<SigInWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SigInModel());
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    32.0, 12.0, 0.0, 24.0),
                                child: Text(
                                  'If you have an account  please enter your email',
                                  style:
