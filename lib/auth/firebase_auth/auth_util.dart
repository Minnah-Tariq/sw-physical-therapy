...
DocumentReference? get currentUserReference =>
    loggedIn ? FillProfileRecord.collection.doc(currentUser!.uid) : null;

FillProfileRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : FillProfileRecord.getDocument(FillProfileRecord.collection.doc(uid))
              .handleError((_) {}),
    )
