...
import 'tryple_model.dart';
export 'tryple_model.dart';

class TrypleWidget extends StatefulWidget {
  const TrypleWidget({super.key});

  @override
  _TrypleWidgetState createState() => _TrypleWidgetState();
}

class _TrypleWidgetState extends State<TrypleWidget> {
  late TrypleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrypleModel());
  }
